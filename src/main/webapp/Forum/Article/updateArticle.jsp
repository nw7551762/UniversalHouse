...
<form method="POST" action="<c:url value='/updateArticle' />" enctype='multipart/form-data'>
	...
	<table>
		...
		<tr height="52">
			<td style="width: 90px;"><label class="fontSize">文章主題：</label>
			</td>
			<td style="width: 290px;"><input type='text' name="title" value="${thisBean.title}" class="fieldWidth" style="width: 200px;" required />
		</tr>
				
		<tr height="52">
			<td style="width: 90px;"><label class="fontSize">內容：</label>
			</td>
			<td style="width: 290px;"><textarea name="content" class="fieldWidth" style="width: 200px;"  required >${thisBean.content}</textarea><br>
			</td>
		</tr>
		...
		<tr>
			<td style="width: 90px;"><label class="fontSize">圖片：</label><br>
			<td><img height='300' width='300' src="<c:url value='/showArticleImage?id=${thisBean.articleId}' />"><br>
				<input name='memberMultipartFile' type='file' accept='image/gif, image/jpeg, image/png' /></td>
		</tr>
...
<c:set var="memberId" value="${cookie['user'].getValue()}" /><br>
