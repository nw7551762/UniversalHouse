...
<body>
<form method="POST" align='center' action="<c:url value='/newArticle_BS'/>" enctype='multipart/form-data'>
	...
	<Table
		...
		<tr height="16">
			<td colspan='4' style="text-align: center; vertical-align: middle;">
				<div class="error"><div class="error">${errorSaveData}${MsgMap.errorIdEmpty}${MsgMap.errorIdDup}</div><br>
				</div>
			</td>
		</tr>
		...
		<tr height="52">
			<td style="width: 90px;"><label class="fontSize">文章主題：</label><br>&nbsp;</td>
			<td style="width: 290px;"><input type='text' name=title
				value="${param.title}" class="fieldWidth" style="width: 200px;"
				required /><br>&nbsp;</td>
		</tr>

		<tr height="52">
			<td style="width: 90px;"><label class="fontSize">內容：</label><br>&nbsp;</td>
			<td style="width: 290px;"><textarea name=content
					class="fieldWidth" style="width: 200px;" required></textarea><br>&nbsp;</td>
		</tr>

		<tr height="52">
			<td style="width: 90px;"><label class="fontSize">領域：</label><br>&nbsp;</td>
			...
			<tr height="42">
				<td colspan='4'><div id="btnArea" align="center">
						<input type="submit" name="submit" id="submit" value="儲存" /> <input
							type="reset" name="submit" id="submit" value="清除" />
					</div></td>
			</tr>
		</Table>
