...
<body onLoad="setFocusToUserId()">
	...
	<div align='center' id="content">
		...
		<form method="POST" action="<c:url value='/updateDatas?articleId=${thisMemberBean.articleId}' />"
			...
			<Table
				...
				<tr height="52">
					<td style="width: 90px;"><label class="fontSize">您的編號：</label><br>&nbsp;
					</td>
					<td style="width: 290px;"><input readonly="readonly" name=authorId
						value="${thisMemberBean.authorId}" class="fieldWidth"
				...
				<tr height="52">
					...
					<td style="width: 290px;"><input type='text' name=title
						value="${thisMemberBean.title}" class="fieldWidth"
						style="width: 200px;" /><br>&nbsp; <font color="red"
						size="-1">${MsgMap.errorIdEmpty}${MsgMap.errorIdDup}</font></td>
				<tr height="52">
					...
					<td style="width: 290px;"><textarea name=content
							class="fieldWidth" style="width: 200px;">${thisMemberBean.content}</textarea><br>&nbsp;
				...
				<tr height="52">
					...
					<img height='100' width='80'
						src="<c:url value='/getImg?id=${thisMemberBean.articleId}' />">
