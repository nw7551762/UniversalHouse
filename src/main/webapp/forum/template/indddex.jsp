...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/open-iconic-bootstrap.min.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/animate.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/owl.carousel.min.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/owl.theme.default.min.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/magnific-popup.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/aos.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/ionicons.min.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/bootstrap-datepicker.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/jquery.timepicker.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/flaticon.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/icomoon.css'/>">
    <link rel="stylesheet" href="<c:url value='/andrea-master/css/style.css'/>">
  </head>
  <body>
