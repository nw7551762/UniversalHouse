...
<body>
	<form action="<c:url value='/modify/modifyByMember.do' />" method="post" enctype="multipart/form-data">
            ...
            <p><label class="t1" for="password">password:</label>
                <input type="text" name="password"></p>
                
            <p><label for="location" class="t1">location:</label>
                <input type="text" name="location"> </p>
                
            <p><label class="t1" for="email">email:</label>
                <input type="text" name="email"></p>
            
            <p><label for="phone" class="t1">phone:</label>
                <input type="text" name="phone"></p>
                
          	<p><label for="memberImage" class="t1">memberImage:</label>
                <input type="file" name="memberImage"></p> 
