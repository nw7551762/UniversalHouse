...
<table border="1">
  ...
  <tr height="80" bgcolor="lightblue" align="center">
    <td  width="350"><p align="left"/>
      <a href="SD3.do">URL Rewriting</a><BR><font face="verdana" size="-2">ch06.ex03.view.SessionDemo3.java<BR>webapp//ch06/sd3Result.jsp</font></td>
    <td  width="350"><p align="left"/>
      <a href="setCookie.jsp">Cookie的設定與使用</a><BR><font face="verdana" size="-2">webapp//ch06/setCookie.jsp<BR>ch06.ex04.controller.CookieTest.java<BR>ch06.ex04.view.DisplayCookie.java</font></td>
  </tr>
